...
program
  ...
  // .addOption(new Option('-dpe, --daily-period-extended', 'extend daily period until the previous sunday').default(true))
  .addOption(new Option('-dp, --weekly-period <count>', 'keep weekly backups for N last weeks from today').default(5, '5 last weeks'))
  // .addOption(new Option('-dpe, --weekly-period-extended', 'extend weekly period until the first week from the months range').default(true))
  .addOption(new Option('-dp, --monthly-period <count>', 'keep monthly backups for N last months from today').default(12, '12 last months'))
  // .addOption(new Option('-dpe, --monthly-period-extended', 'extend monthly period until the previous january').default(true))
  .addOption(new Option('-dp, --yearly-period <count>', 'keep yearly backups for N last years from today').default(2, '2 last years'))
  // .addOption(new Option('-dpe, --yearly-period-extended', 'extend yearly period until the previous january').default(true))
